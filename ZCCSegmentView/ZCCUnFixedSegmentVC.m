...
@interface ZCCUnFixedSegmentVC ()<ZCCSegmentViewDelegate, UIScrollViewDelegate>
...
@implementation ZCCUnFixedSegmentVC
...
- (void)loadSubViews {
    ...
    segmentView.sliderType = ZCCSegmentBottomSliderUnfixed; //是否固定宽
